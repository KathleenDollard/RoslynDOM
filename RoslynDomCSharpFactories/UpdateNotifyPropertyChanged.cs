...
{
   public static class UpdateNotifyPropertyChanged
   {
      public static bool ShouldNotifyPropertyChanged(IProperty prop)
      {
      ...
      public static bool FixNotifyPropertyChanged(IProperty prop)
      {
