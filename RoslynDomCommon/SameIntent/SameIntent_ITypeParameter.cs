...
namespace RoslynDom.Common
{
    ...
    public class SameIntent_ITypeParameter : ISameIntent<ITypeParameter>
    {
        ...
        public bool SameIntent(ITypeParameter one, ITypeParameter other, bool includePublicAnnotations)
        {
            ...
            if (!sameIntent_IReferencedType.SameIntent(one, other, includePublicAnnotations)) { return false; }
            if (!SameIntentHelpers.CheckSameIntentChildList(one.ConstraintTypes, other.ConstraintTypes, includePublicAnnotations)) { return false; }
            return true;
        }
    }
}
