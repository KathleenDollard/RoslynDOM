...
namespace RoslynDomTests
{
   ...
   public class RDomUtilitiesTests
   {
      ...
      public void Can_previous_sibling_fails_on_null()
      {
         var csharpCode = @"
                        public class FooB{}
                        public class FooC{}
         ...
         var root = RDom.CSharp.Load(csharpCode);
         var classes = root.Classes.ToArray();
         var test = ExtensionMethods.PreviousSiblings(null, classes[2]);
      }

      [TestMethod, TestCategory(RDomListTestCategory)]
      [ExpectedException(typeof(ArgumentNullException))]
      public void Can_following_sibling_fails_on_null()
      {
         var csharpCode = @"
                        public class FooB{}
                        public class FooC{}
         ...
         var root = RDom.CSharp.Load(csharpCode);
         var classes = root.Classes.ToArray();
         var test = ExtensionMethods.FollowingSiblings(null, classes[2]);
      }

      [TestMethod, TestCategory(RDomListTestCategory)]
      [ExpectedException(typeof(ArgumentNullException))]
      public void Can_previous_sibling_unil_fails_on_null_list()
      {
         var csharpCode = @"
                        public class FooB{}
                        public class FooC{}
         ...
         var root = RDom.CSharp.Load(csharpCode);
         var classes = root.Classes.ToArray();
         var test = ExtensionMethods.PreviousSiblingsUntil(null, classes[2], x=>true);
      }

      [TestMethod, TestCategory(RDomListTestCategory)]
      [ExpectedException(typeof(ArgumentNullException))]
      public void Can_previous_sibling_unil_fails_on_null_condition()
      {
         var csharpCode = @"
                        public class FooB{}
                        public class FooC{}
         ...
         var root = RDom.CSharp.Load(csharpCode);
         var classes = root.Classes.ToArray();
         var test = ExtensionMethods.PreviousSiblingsUntil(classes, classes[2], null);
      }

      [TestMethod, TestCategory(RDomListTestCategory)]
      [ExpectedException(typeof(ArgumentNullException))]
      public void Can_following_sibling_unil_fails_on_null_object()
      {
         var csharpCode = @"
                        public class FooB{}
                        public class FooC{}
         ...
         var root = RDom.CSharp.Load(csharpCode);
         var classes = root.Classes.ToArray();
         var test = ExtensionMethods.FollowingSiblingsUntil(null, classes[2], x => true);
      }

      [TestMethod, TestCategory(RDomListTestCategory)]
      [ExpectedException(typeof(ArgumentNullException))]
      public void Can_following_sibling_unil_fails_on_null_condition()
      {
         var csharpCode = @"
                        public class FooB{}
                        public class FooC{}
         ...
         var root = RDom.CSharp.Load(csharpCode);
         var classes = root.Classes.ToArray();
         var test = ExtensionMethods.FollowingSiblingsUntil(classes, classes[2], null);
      }
