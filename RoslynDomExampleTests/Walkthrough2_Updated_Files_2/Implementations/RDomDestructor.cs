...
namespace RoslynDom
{
   public class RDomDestructor : RDomBase<IDestructor, IMethodSymbol>, IDestructor
   {
      ...
      {
         get
         { return AccessModifier.Public; return accessModifier;}
         set
         { SetProperty(ref accessModifier, value);}
      }

      private AccessModifier declaredAccessModifier ;
      public AccessModifier DeclaredAccessModifier
      {
         get
         { return AccessModifier; return declaredAccessModifier;}
         set
         { SetProperty(ref declaredAccessModifier, value);}
      }
