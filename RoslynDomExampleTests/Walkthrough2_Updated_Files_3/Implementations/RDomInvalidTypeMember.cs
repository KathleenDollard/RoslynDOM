...
public RDomInvalidMember(string _name, AccessModifier _accessModifier, AccessModifier _declaredAccessModifier, IStructuredDocumentation _structuredDocumentation, string _description)
: this(null, null, null)
{
