...
namespace RoslynDom
{
 ...
 public RDomProperty (string               _name,string _propertyTypeName,AccessModifier               _accessModifier,AccessModifier               _declaredAccessModifier,bool               _isAbstract,bool               _isVirtual,bool               _isOverride,bool               _isSealed,bool               _isStatic,bool               _isNew,bool               _canGet,bool               _canSet,IStructuredDocumentation               _structuredDocumentation,string               _description,IAccessor               _getAccessor,IAccessor               _setAccessor,string _iHasReturnType.ReturnTypeName)
 : this (_name,new RDomReferencedType(_propertyTypeName),_accessModifier,_declaredAccessModifier,_isAbstract,_isVirtual,_isOverride,_isSealed,_isStatic,_isNew,_canGet,_canSet,_structuredDocumentation,_description,_getAccessor,_setAccessor,new RDomReferencedType(_iHasReturnType.ReturnTypeName) ) { NeedsFormatting=true;
 Name=_name;
 ...
 GetAccessor=_getAccessor;
 SetAccessor=_setAccessor;
IHasReturnType.ReturnType=_iHasReturnType.ReturnType;
 }public RDomProperty(string _name, IReferencedType _propertyType, AccessModifier _accessModifier, AccessModifier _declaredAccessModifier, bool _isAbstract, bool _isVirtual, bool _isOverride, bool _isSealed, bool _isStatic, bool _isNew, bool _canGet, bool _canSet, IStructuredDocumentation _structuredDocumentation, string _description, IAccessor _getAccessor, IAccessor _setAccessor, IReferencedType _iHasReturnType.ReturnType)
: this(null, null, null)
{
    NeedsFormatting = true;
    Name = _name;
