...
public RDomTypeParameter(string _name, int _ordinal, bool _hasConstructorConstraint, bool _hasReferenceTypeConstraint, bool _hasValueTypeConstraint, Variance _variance)
: this(null, null, null)
{
    NeedsFormatting = true;
    Name = _name;
    Ordinal = _ordinal;
    HasConstructorConstraint = _hasConstructorConstraint;
    HasReferenceTypeConstraint = _hasReferenceTypeConstraint;
    HasValueTypeConstraint = _hasValueTypeConstraint;
    Variance = _variance;
}
