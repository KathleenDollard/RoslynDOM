...
namespace RoslynDom
{
   ...
   {
 public RDomClass (string _baseTypeName,bool               _isAbstract,bool               _isSealed,bool               _isStatic)
 : this (new RDomReferencedType(_baseTypeName),_isAbstract,_isSealed,_isStatic ) { NeedsFormatting=true;
 BaseType=_baseType;
 IsAbstract=_isAbstract;
 IsSealed=_isSealed;
 IsStatic=_isStatic;
 }public RDomClass(IReferencedType _baseType, bool _isAbstract, bool _isSealed, bool _isStatic)
: this(null, null, null)
{
