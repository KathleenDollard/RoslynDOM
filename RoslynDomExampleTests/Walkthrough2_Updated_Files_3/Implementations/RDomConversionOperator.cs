...
namespace RoslynDom
{
 ...
 public RDomConversionOperator (string               _name,AccessModifier               _accessModifier,AccessModifier               _declaredAccessModifier,string _typeName,bool               _isImplicit,bool               _isStatic,IStructuredDocumentation               _structuredDocumentation,string               _description,bool               _hasBlock)
 : this (_name,_accessModifier,_declaredAccessModifier,new RDomReferencedType(_typeName),_isImplicit,_isStatic,_structuredDocumentation,_description,_hasBlock ) { NeedsFormatting=true;
 Name=_name;
 ...
 HasBlock=_hasBlock;
 }public RDomConversionOperator(string _name, AccessModifier _accessModifier, AccessModifier _declaredAccessModifier, IReferencedType _type, bool _isImplicit, bool _isStatic, IStructuredDocumentation _structuredDocumentation, string _description, bool _hasBlock)
: this(null, null, null)
{
