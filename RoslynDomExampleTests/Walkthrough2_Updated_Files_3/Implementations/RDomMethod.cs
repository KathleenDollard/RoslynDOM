...
namespace RoslynDom
{
 ...
 public RDomMethod (string               _name,string _returnTypeName,AccessModifier               _accessModifier,AccessModifier               _declaredAccessModifier,bool               _isAbstract,bool               _isVirtual,bool               _isOverride,bool               _isSealed,bool               _isNew,bool               _isStatic,bool               _isExtensionMethod,IStructuredDocumentation               _structuredDocumentation,string               _description,bool               _hasBlock)
 : this (_name,new RDomReferencedType(_returnTypeName),_accessModifier,_declaredAccessModifier,_isAbstract,_isVirtual,_isOverride,_isSealed,_isNew,_isStatic,_isExtensionMethod,_structuredDocumentation,_description,_hasBlock ) { NeedsFormatting=true;
 Name=_name;
 ...
 IsNew=_isNew;
 IsStatic=_isStatic;
 IsExtensionMethod=_isExtensionMethod;
 StructuredDocumentation=_structuredDocumentation;
 Description=_description;
 HasBlock=_hasBlock;
 }public RDomMethod(string _name, IReferencedType _returnType, AccessModifier _accessModifier, AccessModifier _declaredAccessModifier, bool _isAbstract, bool _isVirtual, bool _isOverride, bool _isSealed, bool _isNew, bool _isStatic, bool _isExtensionMethod, IStructuredDocumentation _structuredDocumentation, string _description, bool _hasBlock)
: this(null, null, null)
{
