...
namespace RoslynDom
{
   ...
   {
public RDomAttributeValue(string _name, AttributeValueStyle _style, object _value, string _valueConstantIdentifier, LiteralKind _valueType, System.Type _type)
: this(null, null, null)
{
    ...
    Style = _style;
    Value = _value;
    ValueConstantIdentifier = _valueConstantIdentifier;
